            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="widget subscribe no-box">
                        <h5 class="widget-title">Oriol's Coffee<span></span></h5>
                        <p>At Oriol's Coffee we have the best Coffee Quality in Bacalar City.</p>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="widget no-box">
                        ...
                        <ul class="thumbnail-widget">
                            <li>
                                <div class="thumb-content"><a href="#.">Support</a></div>
                            </li>
                            <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>Copyright Oriol's Coffee © 2020. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
